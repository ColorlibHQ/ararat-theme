...
// image default alt
if ( ! function_exists( 'ararat_img_default_alt' ) ) {
	function ararat_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'ararat_img_tag' ) ) {
	function ararat_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = ararat_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'ararat_anchor_tag' ) ) {
	function ararat_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'ararat_heading_tag' ) ) {
	function ararat_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'ararat_paragraph_tag' ) ) {
	function ararat_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'ararat_other_tag' ) ) {
	function ararat_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'ararat_button_element ' ) ) {
	function ararat_button_element( array $args ) {
